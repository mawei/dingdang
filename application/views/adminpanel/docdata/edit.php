			...
			<div class="form-group col-sm-6">
				...
				<div class="col-sm-8 ">
					...
					<?}else if ($value['type'] == 'default'){?>
						<input type="text" class="form-control" extra-type="default" name="<?php echo isset($value['field_name'])?$value['field_name']:'' ?>[]"  id="<?php echo isset($value['field_name'])?$value['field_name']:'' ?>" value="<?php echo isset($value['value'])?$value['value']:$value['field_values'] ?>"> 
					<?}else if ($value['type'] == 'append'){?>
						<input type="text" class="form-control" extra-type="append" append-value="<?php echo isset($value['field_values']) ? $value['field_values']:'';?>" name="<?php echo isset($value['field_name'])?$value['field_name']:'' ?>[]"  id="<?php echo isset($value['field_name'])?$value['field_name']:'' ?>" value="<?php echo isset($value['value'])?$value['value']:'' ?>"> 
					<?}else{?>
					<input type="text" class="form-control" name="<?php echo isset($value['field_name'])?$value['field_name']:'' ?>[]"  id="<?php echo isset($value['field_name'])?$value['field_name']:'' ?>" value="<?php echo isset($value['value'])?$value['value']:'' ?>"  
